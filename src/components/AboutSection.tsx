      ...
      <div className="flex-1 flex justify-center items-center w-full">
        <div className="relative w-full max-w-[400px] sm:max-w-[420px] md:max-w-[480px] lg:max-w-[520px] h-[420px] sm:h-[450px] md:h-[450px]">
          ...
          <img
            ...
            className="absolute left-0 sm:left-0 md:left-4 top-4 sm:top-8 md:top-4 w-56 sm:w-60 md:w-72 lg:w-80 rotate-[-8deg] drop-shadow-2xl hover:rotate-[-5deg] transition-transform duration-300 z-10"
          />
          ...
          <img
            src={mock3}
            alt="KMO App Screenshot"
            className="absolute right-0 sm:right-0 md:right-4 top-16 sm:top-20 md:top-16 w-60 sm:w-64 md:w-80 lg:w-[22rem] rotate-[8deg] drop-shadow-2xl hover:rotate-[5deg] transition-transform duration-300 z-20"
          />
