      ...
      <div className="container mx-auto px-4">
        <div className={`gradient-primary rounded-3xl p-8 md:p-14 text-center transition-all duration-1000 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 justify-center">
            <a href="https://play.google.com/store/apps/details?id=id.kmoapp.literasi" target="_blank" rel="noopener noreferrer" className="bg-card text-foreground font-semibold px-7 py-3.5 rounded-full text-sm hover:opacity-90 transition-all duration-300 hover:scale-105 hover:shadow-lg inline-flex items-center gap-2">
            ...
            <a href="https://mobile.kmoapp.id/" target="_blank" rel="noopener noreferrer" className="bg-card text-foreground font-semibold px-7 py-3.5 rounded-full text-sm hover:opacity-90 transition-all duration-300 hover:scale-105 hover:shadow-lg inline-flex items-center gap-2">
